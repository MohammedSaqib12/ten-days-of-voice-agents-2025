...
# Default FAQ data for "Mohammed Saqib's Store"
DEFAULT_FAQ = [
    {
    ...
    },
    {
        ...
        "answer": "Yes! Saqib releases weekly tutorials on YouTube for free. The paid courses offer deep-dives, code reviews, and certification."
    },
    {
...
class SDRAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions=f"""
            You are 'Sarah', a friendly and professional Sales Development Rep (SDR) for 'Mohammed Saqib's Store'.
            ...
            🚫 **RESTRICTIONS:**
            - If you don't know an answer, say "I'll check with Mohammed Saqib and email you." (Don't hallucinate prices).
            """,
